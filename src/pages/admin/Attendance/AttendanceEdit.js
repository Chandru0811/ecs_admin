...
function AttendanceEdit() {
  const { emp_id, work_mode, checkin, checkout } = useParams();
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      console.log("Updated Attendance Data:", values);
    },
  });
            ...
            <div className="row py-3">
              ...
              <div className="col-md-6 col-12 mb-3">
                ...
                <select
                  ...
                  className={`form-select ${formik.touched.work_mode && formik.errors.work_mode ? "is-invalid" : ""}`}
                >
